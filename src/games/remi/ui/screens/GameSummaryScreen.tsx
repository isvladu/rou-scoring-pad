...
import { winnerOf } from '../../domain/endCondition';
...
export default function GameSummaryScreen() {
  ...
  const { active, load, finish } = useRemiGameStore();
  ...
  useEffect(() => {
    // Same stale-active guard pattern as Rentz / Whist / Phase 10.
  ...
  const winner = winnerOf(active, totals);
  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <Scoreboard
        ...
        totals={totals}
        highlightedPlayerId={winner?.id ?? null}
      />
